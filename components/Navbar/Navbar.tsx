        ...
        <div>
            <div className="navbar">
                    ...
                    <div className='link-pages'> 
                        <Link href="/" className='link home'><Image src={logo} alt="logo" width={50} height={50} /></Link>
                        <Link href="/#aboutme" className='link aboutme' >About Me</Link>
                        <Link href="/#projects" className='link myprojects'>My Projects</Link>
                        <Link href="/#contact" className='link test'>Contact</Link>
                    </div>
                    <div className="link-medias">
                        ...
                        <a href="/CV.pdf" download="CV.pdf" className='link media'><Image src={download} width={40} height={40}  alt="logo" /></a>
                    </div>
